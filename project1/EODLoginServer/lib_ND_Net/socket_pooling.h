...
public:
	...
	enum
	{
		en_server_type_version_server=0,
		en_server_type_login_server,
	};
	int						m_iServerType;

	int get_server_type()		{ return m_iServerType; }
	int set_server_type_ps()	{ m_iServerType = en_server_type_version_server; return 0; }
	int set_server_type_ls()	{ m_iServerType = en_server_type_login_server; return 0; }
