...
#ifdef ND_EXCEL_LOADER_EXPORTS
#define ND_DLLCLASS		__declspec(dllexport)
#else
#define ND_DLLCLASS
#endif
...
class ND_DLLCLASS COleDispatchDriver ;
...
class ND_DLLCLASS _Application : public COleDispatchDriver
{
public:
...
class ND_DLLCLASS _Worksheet : public COleDispatchDriver
{
public:
...
class ND_DLLCLASS _Workbook : public COleDispatchDriver
{
public:
...
class ND_DLLCLASS Workbooks : public COleDispatchDriver
{
public:
...
class ND_DLLCLASS Font : public COleDispatchDriver
{
public:
...
class ND_DLLCLASS Range : public COleDispatchDriver
{
public:
...
class ND_DLLCLASS Worksheets : public COleDispatchDriver
{
public:
...
class ND_DLLCLASS Interior : public COleDispatchDriver
{
public:
...
_TCHAR const excelField[256][3] = {
	_T("A"), _T("B"), _T("C"), _T("D"), _T("E"),
	_T("F"), _T("G"), _T("H"), _T("I"), _T("J"),
	_T("K"), _T("L"), _T("M"), _T("N"), _T("O"), _T("P"), _T("Q"), _T("R"), _T("S"), _T("T"),
	_T("U"), _T("V"), _T("W"), _T("X"), _T("Y"),        // 26
	_T("Z"),
	
	_T("AA"), _T("AB"), _T("AC"), _T("AD"), _T("AE"), _T("AF"), _T("AG"), _T("AH"), _T("AI"), _T("AJ"),
	_T("AK"), _T("AL"), _T("AM"), _T("AN"), _T("AO"), _T("AP"), _T("AQ"), _T("AR"), _T("AS"), _T("AT"),
	_T("AU"), _T("AV"), _T("AW"), _T("AX"), _T("AY"),   // 26 - 52
	_T("AZ"),
	
	_T("BA"), _T("BB"), _T("BC"), _T("BD"), _T("BE"), _T("BF"), _T("BG"), _T("BH"), _T("BI"), _T("BJ"),
	_T("BK"), _T("BL"), _T("BM"), _T("BN"), _T("BO"), _T("BP"), _T("BQ"), _T("BR"), _T("BS"), _T("BT"),
	_T("BU"), _T("BV"), _T("BW"), _T("BX"), _T("BY"),   // 26 - 78
	_T("BZ"),
	
	_T("CA"), _T("CB"), _T("CC"), _T("CD"), _T("CE"), _T("CF"), _T("CG"), _T("CH"), _T("CI"), _T("CJ"),
	_T("CK"), _T("CL"), _T("CM"), _T("CN"), _T("CO"), _T("CP"), _T("CQ"), _T("CR"), _T("CS"), _T("CT"),
	_T("CU"), _T("CV"), _T("CW"), _T("CX"), _T("CY"),   // 26 - 104
	_T("CZ"),
	
	_T("DA"), _T("DB"), _T("DC"), _T("DD"), _T("DE"), _T("DF"), _T("DG"), _T("DH"), _T("DI"), _T("DJ"),
	_T("DK"), _T("DL"), _T("DM"), _T("DN"), _T("DO"), _T("DP"), _T("DQ"), _T("DR"), _T("DS"), _T("DT"),
	_T("DU"), _T("DV"), _T("DW"), _T("DX"), _T("DY"),   // 26 - 130
	_T("DZ"),
	
	_T("EA"), _T("EB"), _T("EC"), _T("ED"), _T("EE"), _T("EF"), _T("EG"), _T("EH"), _T("EI"), _T("EJ"),
	_T("EK"), _T("EL"), _T("EM"), _T("EN"), _T("EO"), _T("EP"), _T("EQ"), _T("ER"), _T("ES"), _T("ET"),
	_T("EU"), _T("EV"), _T("EW"), _T("EX"), _T("EY"),   // 26 - 156
	_T("EZ"),
	
	_T("FA"), _T("FB"), _T("FC"), _T("FD"), _T("FE"), _T("FF"), _T("FG"), _T("FH"), _T("FI"), _T("FJ"),
	_T("FK"), _T("FL"), _T("FM"), _T("FN"), _T("FO"), _T("FP"), _T("FQ"), _T("FR"), _T("FS"), _T("FT"),
	_T("FU"), _T("FV"), _T("FW"), _T("FX"), _T("FY"),   // 26 - 182
	_T("FZ"),
	
	_T("GA"), _T("GB"), _T("GC"), _T("GD"), _T("GE"), _T("GF"), _T("GG"), _T("GH"), _T("GI"), _T("GJ"),
	_T("GK"), _T("GL"), _T("GM"), _T("GN"), _T("GO"), _T("GP"), _T("GQ"), _T("GR"), _T("GS"), _T("GT"),
	_T("GU"), _T("GV"), _T("GW"), _T("GX"), _T("GY"),   // 26 - 208
	_T("GZ"),
	
	_T("HA"), _T("HB"), _T("HC"), _T("HD"), _T("HE"), _T("HF"), _T("HG"), _T("HH"), _T("HI"), _T("HJ"),
	_T("HK"), _T("HL"), _T("HM"), _T("HN"), _T("HO"), _T("HP"), _T("HQ"), _T("HR"), _T("HS"), _T("HT"),
	_T("HU"), _T("HV"), _T("HW"), _T("HX"), _T("HY"),   // 26 - 234
	_T("HZ"),
	
	_T("IA"), _T("IB"), _T("IC"), _T("ID"), _T("IE"), _T("IF"), _T("IG"), _T("IH"), _T("II"), _T("IJ"),
	_T("IK"), _T("IL"), _T("IM"), _T("IN"), _T("IO"), _T("IP"), _T("IQ"), _T("IR"), _T("IS"), _T("IT"),
	_T("IU"), _T("IV") 
	// 22 - 256
};

//char const excel_EOF[] = "-1" ;
TCHAR const excel_EOF[] = _T("-1") ;
