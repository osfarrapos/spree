...
#define _PD_BUGFIX_20080616_					// 20080610 : 6/16 일 패치시 수정될 버그. : 다른 나라는 영역기 들어갈 때, 같이 들어갈 것.

//#define _PD_SKILL_EXTEND_						// 20080519 : 스킬 슬롯의 개수 확장(80개). DB/DS/GS ExtendSkillSlot.doc 참고.
//#define _PD_SKILL_EXTEND_100_					// 20080520 : 스킬 슬롯의 개수를 100 개까지 확장. GS 만 업데이트
#define _PD_QUEST_FOR_DUNGEON_					// 20080522 :

#define _PD_ITEM_BONUS_SPELL_APPLY_				// 20080507 : 아이템/캐릭터의 보너스 Apply 가, 기공에서 적용되지 않던 것 적용. : 국내 적용후, 없앤다.
#define _PD_MOB_M_DEFENCE_FIX_					// 20080506 : 몬스터 물리/기공 방어 계산 오류 수정 + 캐릭터 기공 방어 계산 오류.

#define _PD_RECALL_MONSTER_						// 20080430 : 외도세력 소환 포션.


#define _PD_CASH_INVEN_							// 20080430 : 캐쉬 인벤 및 표국 확장 : DS/GS/GMS/Client : CashInventory.doc

//#define _PD_PARTY_INFO_CLASSGRADE_				// 20080410 : 파티 정보에 역할 등급 추가. : DS
...
#define _PD_SPELL_WEAPON_PENALTY_				// 20080314 : 강무기 패널치 조건 -- 지혜->민첩 으로.
...
#define _PD_CHANNEL_DAM_DISPLAY_				// 20080225 : 채널 공격의 데미지 표시.

#define _PD_SETITEM_							// 20080213 : 세트 아이템 적용.
#define _PD_MOB_APPLYEFFECT_MOD_				// 20080212 : 몬스테에게 적용되는 상태효과 중, 특정 상태효과는 다른 것으로 바뀐다.


#define _PD_PKBUG_MASK__ATTACKER_NAME_			// 20080122 : PK 공격자가 복면인일 경우, 이름이 뜨지 않도록.(Vina)

#define _PD_COLLECT_PACKET_MODIFY_				// 20080117 : 수집 패킷의 필요 정보 부족으로 버그 발생 -> 필요 정보 추가
...
#define _PD_GAME_EVENT_							// 20071112 Game Event(DB/DS/GS) : Free Match 

//////////////////////////////////////////////////////////////////////////
// 해킹 방지.
//#define _PD_CHECK_CHARAC_MOVE_TEST_				// 20081115 : 채팅으로 클라이언트에 오류 전송.
//#define _PD_CHECK_CHARAC_MOVE_					// 20080110 : 캐릭터 이동 패킷 검사.
#define _PD_CHECK_ATKPACKET_DISTANCE_
#define _PD_CHECK_ATK_IN_CHANNEL_				// 20071101 채널링 중에 전투가 오면, 끊는다.


//////////////////////////////////////////////////////////////////////////

#define _PD_ITEM_PM_COMMON_1024					// 아이테의 공성/방어력/공회피율 물리/기공에 모두 적용하고, 버그 수정.
...
#define _PD_PVP_EF
#define _PD_CASTLFECT_MODIFY_					// 효과에 따라, PVP 감소 효과가 다르게 적용.
...
//#define _PD_GAMEGUARD_VER_1_					// 게임가드 인증 버전 1 사용. : 2008/02/28 이전. 컴파일 전, lib 교체. 배포시. Dll 포함.
//#define _PD_GAMEGUARD_VER_2_					// 게임가드 인증 버전 2 사용. : 2008/02/28 이후. 컴파일 전, lib 교체. 배포시. Dll 포함.
// 대만 테스트.
...
// Event 
//////////////////////////////////////////////////////////////////////////
//#define _PD_LEVEL_PRESENT_						// 20080225 : 레벨 달성 선물 주기.
