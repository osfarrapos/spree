// XWindow_MnDTotalPoint.cpp: implementation of the _XWindow_MnDTotalPoint class.
//
//////////////////////////////////////////////////////////////////////
...
#include "XWindow_MnDTotalPoint.h"

//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

_XWindow_MnDTotalPoint::_XWindow_MnDTotalPoint()
{
	m_pTitleImage = NULL;
...
BOOL _XWindow_MnDTotalPoint::Initialize()
{
...
void _XWindow_MnDTotalPoint::DestroyWindow()
{
	_XWindow::DestroyWindow();
}

void _XWindow_MnDTotalPoint::Draw( _XGUIObject*& pfocusobject )
{	
	...
	//포인트가 999일 때
	if( g_pLocalUser->m_pLocalMnDInfomation.nTotalKillCount == 999 )
	{
...
BOOL _XWindow_MnDTotalPoint::Process( _XGUIObject*& pfocusobject )
{
...
void _XWindow_MnDTotalPoint::SetNumberProcess()
{
	int nHundred = g_pLocalUser->m_pLocalMnDInfomation.nTotalKillCount/100; //백의자리
	int nTen = (g_pLocalUser->m_pLocalMnDInfomation.nTotalKillCount%100)/10; //십의자리
	int nOne = (g_pLocalUser->m_pLocalMnDInfomation.nTotalKillCount%100)%10; //일의 자리
...
void _XWindow_MnDTotalPoint::ShowWindow( BOOL show )
{
	_XWindow::ShowWindow(show);
}

void _XWindow_MnDTotalPoint::MoveWindow( int X, int Y )
{			
